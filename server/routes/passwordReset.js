...
// send password link
passwordRoutes.route("/password-reset").post(async(req, res) => {
	console.log("in passowrd reset post");
	try {
...
//  set new password
passwordRoutes.route("/password-reset/:id/:token").post(async (req, res) => {
	try {
